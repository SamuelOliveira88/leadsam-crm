...
-- Promove usuário existente (se já cadastrado) para master
UPDATE public.perfis
SET role = 'master', grupo_id = NULL, corretor_id = NULL
WHERE id IN (SELECT id FROM auth.users WHERE lower(email) = 'toni.boacasa@gmail.com');