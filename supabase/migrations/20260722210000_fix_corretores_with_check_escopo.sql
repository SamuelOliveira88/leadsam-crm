-- Corrige a política corretores_write_escopo para exigir empresa_id no WITH CHECK,
-- impedindo que master/gerente insira ou atualize corretores em outra empresa.
