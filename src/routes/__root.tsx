    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-md border border-input px-4 py-2 text-sm font-medium">Ir para início</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://alexandria-leds.lovable.app/__l5e/assets-v1/18242716-08a5-43df-8a80-116ecec6f0e9/alexandria-cover.png" },
      ...
      { name: "twitter:image", content: "https://alexandria-leds.lovable.app/__l5e/assets-v1/18242716-08a5-43df-8a80-116ecec6f0e9/alexandria-cover.png" },
    ],
    links: [
