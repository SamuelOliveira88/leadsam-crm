...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ImobLead — CRM com IA para corretores" },
      { property: "og:description", content: "Gestão inteligente de leads imobiliários com IA integrada." },
